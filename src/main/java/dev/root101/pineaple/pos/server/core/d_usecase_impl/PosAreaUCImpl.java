 ...
 */
public class PosAreaUCImpl extends DefaultCRUDUseCase<PineaplePOSAreaDomain, Integer, PosAreaRepo> implements PosAreaUC {

    public PosAreaUCImpl() {
        super(PosCoreModule.find(PosAreaRepo.class));
    }
